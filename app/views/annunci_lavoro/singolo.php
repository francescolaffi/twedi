...
$page_title = "Annuncio di lavoro: {$annuncio->titolo_annuncio}";
...
<?php if ($view->session()->is_admin() || ($view->session()->user_id() === $autore->utente_id)): ?>
...
<div class="context_info">
	<a href="<?php echo $view->url_for('annunci_lavoro') ?>" title='Vai alla lista di tutti gli annunci di lavoro pubblicati' class='link_section'>Vedi tutti gli annunci di lavoro</a>
</div>
