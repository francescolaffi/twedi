...
$page_title = $content_title = "Annunci di lavoro";
?>

<?php if ($view->session()->is_logged_in()): ?>
<div id="context_actions" >
	<p>
		<a href="<?php echo $view->url_for('annunci_lavoro', array('action' => 'inserisci')); ?>" title='Inserisci un annuncio' class='link_inserisci' rel='nofollow'>Inserisci un annuncio</a>
	</p>
</div>
<?php endif; ?>
